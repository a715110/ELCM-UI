...
PrimeFaces.widget.Rain = PrimeFaces.widget.BaseWidget.extend({
  ...
  _init: function () {
    ...
    this.topbarItems = this.topbar.find(
        '.layout-topbar-actions > li.topbar-item');
    ...
    this.profileButton = this.profileContainer.children(
    ...
    this.configMenuClose = this.configMenu.find(
        '> .layout-config-content > .layout-config-close');
        ...
        function () {
          if (!$this.menuClick) {
            $this.wrapper.removeClass(
                'layout-overlay-active layout-mobile-active');
          ...
          if (!$this.profileMenuClick && ($this.isHorizontal() || $this.isSlim()
              || $this.isSlimPlus())) {
          ...
          if (!$this.topbarItemClicked) {
            $this.removeTopbarClassFromAllItems(null, 'active-topmenuitem',
                $this.topbarItems.filter('.active-topmenuitem'));
          }
          ...
          if (!$this.configMenuClicked && $this.configMenu.hasClass(
              'layout-config-active')) {
            if (!$this.wrapper.hasClass('layout-mobile-active')
                && !$this.wrapper.hasClass('layout-overlay-active')) {
              $(document.body).removeClass('blocked-scroll');
            }
  ...
  bindTopbarEvents: function () {
    ...
    this.topbarLinks.off('click.topbar').on('click.topbar', function (e) {
      ...
      if ($this.isMobile()) {
        $this.removeTopbarClassFromAllItems(null, 'active-topmenuitem',
            $this.topbarItems.filter('.active-topmenuitem').not(item));
      } else {
    ...
    this.topbarSearchItemMenu.off('click.topbar').on('click.topbar',
        function (e) {
          $this.topbarItemClicked = true;
        });
  },
  ...
  bindRightPanelEvents: function () {
    ...
    this.rightpanelButton.off('click.rightpanel').on('click.rightpanel',
        changeRightpanelState.bind(this));
    this.rightpanelExitButton.off('click.rightpanel').on('click.rightpanel',
        changeRightpanelState.bind(this));
  ...
  saveMenuState: function () {
    ...
    $.cookie('rain_expandeditems', this.expandedMenuitems.join(','),
        {path: '/'});
  },
  ...
  restoreMenuState: function () {
    ...
    if (sidebarCookie) {
      this.wrapper.addClass(
          'layout-wrapper-static layout-wrapper-static-restore');
    }
...
PrimeFaces.RainConfigurator = {
  ...
  changeSectionTheme: function (theme, section) {
    ...
    wrapperElement.attr('class',
        styleClass.replace(sectionClass, section + '-' + theme));
  },
  ...
  changeMenuMode: function (menuMode) {
    ...
    switch (menuMode) {
      case 'layout-static layout-static-active':
        wrapper.addClass('layout-static layout-static-active').removeClass(
            'layout-overlay layout-slim layout-horizontal layout-slim-plus');
        this.clearLayoutState();
        break;

      case 'layout-overlay':
        wrapper.addClass('layout-overlay').removeClass(
            'layout-static layout-slim layout-horizontal layout-slim-plus layout-static-active');
        this.clearLayoutState();
        break;

      case 'layout-horizontal':
        wrapper.addClass('layout-horizontal').removeClass(
            'layout-static layout-overlay  layout-slim layout-slim-plus layout-static-active');
        this.clearLayoutState();
        break;

      case 'layout-slim':
        wrapper.addClass('layout-slim').removeClass(
            'layout-static layout-overlay layout-horizontal layout-slim-plus layout-static-active');
        this.clearLayoutState();
        break;

      case 'layout-slim-plus':
        wrapper.addClass('layout-slim-plus').removeClass(
            'layout-static layout-overlay layout-horizontal  layout-slim layout-static-active');
        this.clearLayoutState();
        break;

      default:
        wrapper.addClass('layout-static').removeClass(
            'layout-overlay layout-slim layout-horizontal layout-slim-plus ');
        this.clearLayoutState();
        break;
    }
